...
type CategoryId = 'salary' | 'freelance' | 'investment' | 'gift' | 'refund' | 'bonus' | 'rental' | 'other';
...
const CATEGORIES: Category[] = [
  { id: 'salary', label: 'Salary', icon: 'badge', color: 'primaryContainer' },
  { id: 'freelance', label: 'Freelance', icon: 'laptop', color: 'secondaryContainer' },
  { id: 'investment', label: 'Investment', icon: 'trending-up', color: 'primaryContainer' },
  { id: 'gift', label: 'Gift', icon: 'card-giftcard', color: 'tertiaryContainer' },
  { id: 'refund', label: 'Refund', icon: 'reply', color: 'secondaryContainer' },
  { id: 'bonus', label: 'Bonus', icon: 'workspace-premium', color: 'tertiaryContainer' },
  { id: 'rental', label: 'Rental', icon: 'house', color: 'primaryContainer' },
...
export default function AddIncomeScreen() {
  ...
  const [category, setCategory] = useState<CategoryId>('salary');
  ...
  const handleSave = async () => {
    ...
    const catId = await getCategoryIdByFormId(category, 'income');
    await createTransaction({ name: name.trim(), amount: parseFloat(amount), type: 'income', category_id: catId, date: `${m}-${d}`, notes: notes.trim() || null });
    router.back();
  };
    ...
    <View style={[styles.root, { backgroundColor: colors.background }]}>
      <SafeAreaView edges={['top']} style={styles.safeTop}>
        <View style={[styles.header, { borderBottomColor: colors.surfaceContainerHighest }]}>
          ...
          <Text style={[styles.headerTitle, { color: colors.onSurface }]}>Add Income</Text>
      ...
      >
        ...
        >
          <Text style={[styles.fieldLabel, { color: colors.onSurfaceVariant }]}>Income Name</Text>
          <TextInput
          ...
          <View style={[styles.amountRow, { backgroundColor: colors.primaryContainer + '40' }]}>
            <Text style={[styles.currencySign, { color: colors.primary }]}>{currencySymbol}</Text>
            <TextInput
          ...
          <View style={[styles.dateRow]}>
            ...
            <TextInput
              style={[styles.dateDayInput, { backgroundColor: colors.surfaceContainerLow, color: colors.onSurface }]}
              value={day}
          ...
          <View style={[styles.recurringRow, { backgroundColor: colors.surfaceContainerLow, borderRadius: Radius.lg }]}>
